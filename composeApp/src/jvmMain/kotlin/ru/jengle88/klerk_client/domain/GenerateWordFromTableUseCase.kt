package ru.jengle88.klerk_client.domain

import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.flow
import ru.jengle88.klerk_client.data.WordDocumentEditor
import java.io.File
...
class GenerateWordFromTableUseCase {
    ...
    private fun getMasks(masksFile: File): List<String> {
       return masksFile.readText().split(";").run {
    ...
    private fun getFile(folder: File, fileName: String): File? {
